...
public class TicTacToeGUI extends Application {
	...
	private void setupMenus() {
		...
		MenuItem textAreaView = new MenuItem("TextArea");
		MenuItem drawingView = new MenuItem("DrawingArea");
		Menu views = new Menu("Views");
		views.getItems().addAll(buttonView,textAreaView,drawingView);
		...
		buttonView.setOnAction(menuListener);
		textAreaView.setOnAction(menuListener);
		drawingView.setOnAction(menuListener);
	}
	...
	private class MenuItemListener implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			if (text.equals("ButtonView"))
				setViewTo(buttonView);
			else if (text.equals("TextArea"))
				setViewTo(textAreaView);
			else if (text.equals("DrawingArea"))
